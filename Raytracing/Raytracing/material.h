...
public:
	...
	virtual bool scatter(
		...
		//being inside of a refractive material has no snell's solution
		//if inside the material then the light is totally reflected
		...
		scattered = ray(rec.p, direction); //use either refraction or reflrection direction
